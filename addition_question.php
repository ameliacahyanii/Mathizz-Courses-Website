...
<!DOCTYPE html>
  <html lang="en">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo">
          <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
            <li class="nav-item active position-relative">
              <a class="nav-link main=" style="color: #243142;" href="#home">Home</a>
            </li>
            <li class="nav-item position-relative">
              <a class="nav-link" href="#category">Learning Library</a>
            </li>
            <li class="nav-item position-relative">
    ...
    <div class="content-2-3 container-xxl mx-auto p-0  position-relative" style="font-family: 'Poppins', sans-serif; background-color:#64D3FF;">
      <div class="text-center title-text">
        <h1 class="text-title" style="color: #0905DE;">Addition Quizz</h1>
...
<div class="card-block grid-padding text-center">
        <div class="card" style="background-color: #ffff;">
        <h3 class="icon-title" style="color:#0905DE">Question 1</h3>

          <div class="d-flex flex-lg-row flex-column align-items-center">
            <div class="my-5">
              <img src="images/addition_1.png" width= "300px"/>
            </div>
            ...
            <img src="images/=(1).png" width= "60px"/>
            <img src="images/answer(1).png" width= "100px" style="margin-left: 70px; margin-top:100px;"/>
...
function myFunction() {
  ...
  popup.classList.toggle("show");
      ...
      <div class="grid-padding text-center">
        ...
        <!-- <div class="popup1" onclick="myFunction()" style="width:30%">
<buttonn class="btn btn-card text-white">10</button>
  <span class="popuptext" id="myPopup1">Correct</span>
</div>

<div class="popup2" onclick="myFunction()">
<buttonn class="btn btn-card text-white" style="width:30%">8</button>
  <span class="popuptext" id="myPopup2">Wrong</span>
</div>

<div class="popup3" onclick="myFunction()" style="width:30%">
<buttonn class="btn btn-card text-white">4</button>
  <span class="popuptext" id="myPopup3">Wrong</span>
</div> -->
...
button {
  ...
  outline: none;
          ...
          <!-- <div class="col-lg-4 column">
            <a href="addition_detail.php" class="btn btn-card text-white">10</a>
          </div>
          <div class="col-lg-4 column">
            <a href="addition_detail.php" class="btn btn-card text-white">8</a>
          </div>
          <div class="col-lg-4 column">
            <a href="addition_detail.php" class="btn btn-card text-white">4</a>
          </div> -->
        </div>
      </div>
</div>
